...
export default function({ specs }) {
  ...
  // var lum_array = generateNumberOfSteps(Curves.easeInQuad, specs.steps);
  ...
  var lum_array = generateNumberOfSteps(Curves.easeOutQuad, specs.steps);
  var sat_array = generateNumberOfSteps(Curves.easeOutQuad, specs.steps);
  var hue_array = generateNumberOfSteps(Curves.easeInQuad, specs.steps);
